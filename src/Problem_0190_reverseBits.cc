...
{
  Solution s;
  EXPECT_EQ_INT(0b00111001011110000010100101000000, s.reverseBits(0b00000010100101000001111010011100));
  EXPECT_EQ_INT(0b10111111111111111111111111111111, s.reverseBits(0b11111111111111111111111111111101));
  EXPECT_SUMMARY;
}
